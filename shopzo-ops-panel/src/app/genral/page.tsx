...
import { Department, Role } from "@/store/types/genral";
import { setDepartments, setRoles, deleteDepartment, deleteRole, addDepartment, addRole } from "@/store/slices/genralSlice";
...
const GeneralPage = () => {
    ...
    const handleAddDepartmenetformData = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        setAddDepartmentFormData({ ...addDepartmentFormData, [e.target.name]: e.target.value });
    }

    const handleAddRoleFormData = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-md w-full p-6 border border-gray-200 dark:border-slate-700">
                            ...
                            <form onSubmit={handleAddDepartment}>
                                <div className="mb-4">
                                    ...
                                    <input value={addDepartmentFormData.name} onChange={handleAddDepartmenetformData} type="text" id="departmentName" name="name" className="w-full px-4 py-2.5 text-gray-900 dark:text-white bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white transition-colors text-sm" placeholder="Enter department name" required />
                                </div>
                                <div className="mb-4">
                                    ...
                                    <textarea value={addDepartmentFormData.description} onChange={handleAddDepartmenetformData} id="departmentDescription" name="description" className="w-full px-4 py-2.5 text-gray-900 dark:text-white bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white transition-colors text-sm" placeholder="Enter department description" required />
                                </div>
