  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold text-gray-900">Delivery Dashboard</h1>
          <p className="mt-2 text-sm text-gray-600">Manage deliveries and track performance</p>
        </div>
