            ...
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
                ...
                <div className="flex mb-8 border-b border-gray-200">
                    <button
                        ...
                        className={`flex-1 py-3 cursor-pointer text-center font-medium transition-colors ${!isSignUp
                    ...
                    <button
                        ...
                        className={`flex-1 cursor-pointer py-3 text-center font-medium transition-colors ${isSignUp
                            ? "text-black border-b-2 border-black"
                            : "text-gray-500 hover:text-gray-700"
                            }`}
                    >
                        ...
                        <div>
                            ...
                            <div className="relative w-full">
                                <input
                                    ...
                                    onChange={handleChange}
                                    minLength={6}
                                    className={`w-full text-black border rounded-lg px-4 py-2.5 pr-12 focus:outline-none focus:ring-2 focus:border-transparent transition ${error
